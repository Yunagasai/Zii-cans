...
const gcrevoke = ["6285353027631-1621430788@g.us"]
shp = '⬡'
...
console.log(color(figlet.textSync(`${spc1}Ranz Bot Wa`, {
font: 'Standard',
...
fkontakk = { key: {
  fromMe: false,
    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6285353027631-1604595598@g.us' } : {})
},
 message: {
